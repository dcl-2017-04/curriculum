...
x * y
#>  [1]  76 174 184 110 156 168 176 104   4 186
```
...
``` r
x - min(x)
#>  [1] 36 85 90 53 76 82 86 50  0 91
(x - mean(x)) / sd(x)
#>  [1] -0.9701301  0.6747272  0.8425697 -0.3994653  0.3726105  0.5740216
#>  [7]  0.7082957 -0.5001709 -2.1785966  0.8761382
```
...
<img src="diagrams/rolling-dir.png" width="494" />
