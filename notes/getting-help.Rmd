...
*   [Google is your friend](http://xkcd.com/627/). Google is your friend. 
...
If you do get to help from others, strive to create a __reprex__, a minimal reproducible example. There are three things you need to include to make your example reproducible: required packages, data, and code.
